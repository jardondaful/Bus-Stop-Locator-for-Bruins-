...
### Julie code begin - closest facility
try:
...
##    incidents = os.path.join(FolderPath, "Geocoded_point.shp")
...
##    field_mappings["Name"].mappedFieldName = "NOM"
    arcpy.na.AddLocations(layer_object, incidents_lyrName, incidents)   # NEED TO INCORPERATE FIELD MAPPING 
